            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <p className="bg-gray-100 p-3 rounded-md">
                  Explain the process of photosynthesis and draw a simple
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-100 p-3 rounded-md h-32 overflow-y-auto">
                  <p>
                    Photosynthesis is the process where plants make their own
                    food using sunlight. The plant takes in carbon dioxide and
                    water and converts them into glucose and oxygen. This
                    happens in the chloroplasts which contain chlorophyll. The
                    process has light-dependent reactions and light-independent
                    reactions. [Student's diagram showing basic photosynthesis
                    process]
                  </p>
                </div>
              </div>
                ...
                <div className="bg-gray-50 p-4 rounded-md min-h-32 border border-gray-200">
                  {isTyping ? (
                    ...
                    <p className="text-gray-500 italic">
                      Click "Grade Now" to see AI feedback
                    </p>
                  )}
                </div>
              </div>
